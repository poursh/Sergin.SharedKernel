...
Building-block library for the Sergin platform: cross-cutting `Domain`, `Application`, `Infrastructure`, `Presentation`, and host-bootstrap abstractions shared by every Sergin module. Part of the [Sergin](https://github.com/poursh/Sergin.MeterMinder) HES (Head-End System) platform for utility smart metering.
